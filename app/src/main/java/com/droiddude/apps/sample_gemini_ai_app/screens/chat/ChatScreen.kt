...
fun ChatList(
    ...
    LazyColumn(
        ...
        items(chatMessages.reversed()) { message ->
            ChatBubbleItem(chatMessage = message)
        }
    }
}
...
fun ChatBubbleItem(
    ...
    val isModelMessage = chatMessage.participant == Participant.MODEL || chatMessage.participant == Participant.ERROR
...
fun ChatBubblePreview() {
    Sample_Gemini_AI_AppTheme {
        ChatBubbleItem(chatMessage = ChatMessage(text = "Hello, I have 2 dogs with me. One is Labrador and another is a Pug. Give me instructions on how to feed them."))
    }
}
